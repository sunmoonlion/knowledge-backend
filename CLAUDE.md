...
> 本仓细节见 `../../k8s/sunmoonai/docs/project-guide/repos/knowledge-app.md`。
...
**`interfaces/http/` 与 `interfaces/endpoints/` 的分工**：模板提供的通用面在 `http/`，
本仓的领域路由在 `endpoints/`。加业务接口去 `endpoints/`。
